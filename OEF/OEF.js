...
table1 = [14289347, 14894395, 8423662, 7818613, 16777140, 2487794, 1882746,
		8353479, 8958528];
table2 = [14894395, 7818613, 2487794, 8353479, 1, 14894395, 7818613, 2487794,
		8353479];
table4 = [7818613, 8353479, 14894395, 2487794, 1, 7818613, 8353479, 14894395,
		2487794];
...
function noeftab64(tab) {
	var r = new OEF();
	for ( var i = 0; i < 8; i++) {
		r.arr[i] = parseInt(base64Decode(tab[i]), 16);
	}
	return r;
}
function randOEF() {
...
OEF.prototype.modInverse = function() { // Inversion modulaire ?
	// step 1
